from pynta.utils import set_initial_magnetic_moments_by_element     ##Azeez Added 
...
def get_lattice_parameters(metal,surface_type,software,software_kwargs,da=0.1,magnetization_dict=None, a0=None):        ### Azeez added magnetization_dict=None,
    ...
    if surface_type != "hcp0001":
        ...
        def f(a):
            ...
            if magnetization_dict and software.lower() == "espresso":   ## Azeez added 
                slab = set_initial_magnetic_moments_by_element(slab, magnetization_dict)        ##Azeez added 
